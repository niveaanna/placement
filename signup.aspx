<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="placement.signup" %>
    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td>
                    <asp:Button ID="btnsignup" runat="server" OnClick="btnsignup_Click" style="margin-left: 97px" Text="LOGIN" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
